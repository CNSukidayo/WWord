...
public class OriginTextContentRenderer implements Renderer {

    private final boolean stripNewlines;

    private final List<TextContentNodeRendererFactory> nodeRendererFactories;

    private OriginTextContentRenderer(Builder builder) {
    ...
    /**
     * Create a new builder for configuring an {@link OriginTextContentRenderer}.
     *
     * @return a builder
     */
    ...
    /**
     * Builder for configuring an {@link OriginTextContentRenderer}. See methods for default configuration.
     */
    public static class Builder {
        ...
        /**
         * @return the configured {@link OriginTextContentRenderer}
         */
        public OriginTextContentRenderer build() {
            return new OriginTextContentRenderer(this);
        }
        ...
        public Builder extensions(Iterable<? extends Extension> extensions) {
            for (Extension extension : extensions) {
                if (extension instanceof OriginTextContentRenderer.TextContentRendererExtension) {
                    OriginTextContentRenderer.TextContentRendererExtension textContentRendererExtension =
                            (OriginTextContentRenderer.TextContentRendererExtension) extension;
    ...
    /**
     * Extension for {@link OriginTextContentRenderer}.
     */
    public interface TextContentRendererExtension extends Extension {
        void extend(OriginTextContentRenderer.Builder rendererBuilder);
    }
